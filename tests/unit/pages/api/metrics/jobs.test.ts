...
import { GET } from '../../../../../src/pages/api/metrics/jobs';
vi.mock('../../../../../src/actions/get-job-metrics');
vi.mock('@/lib/api/api-guard');

describe('Metrics API - GET ../../../../../src/pages/api/metrics/jobs', () => {
  beforeEach(() => {
    vi.resetAllMocks();
    vi.mocked(ApiGuard.protect).mockResolvedValue(undefined);
  });

  it('should call GetJobMetricsAction and return success', async () => {
