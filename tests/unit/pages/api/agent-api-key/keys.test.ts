...
import { POST } from '../../../../../src/pages/api/agent-api-key/keys';
vi.mock('../../../../../src/actions/create-agent-api-key');
vi.mock('@/lib/api/api-guard');

describe('AgentApiKey API - POST ../../../../../src/pages/api/agent-api-key/keys', () => {
  beforeEach(() => {
    vi.resetAllMocks();
