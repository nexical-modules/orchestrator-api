...
import { POST } from '../../../../../src/pages/api/orchestrator/check-stale';
vi.mock('../../../../../src/actions/check-stale-agents-orchestrator');
vi.mock('@/lib/api/api-guard');

describe('Orchestrator API - POST ../../../../../src/pages/api/orchestrator/check-stale', () => {
  beforeEach(() => {
    vi.resetAllMocks();
    vi.mocked(ApiGuard.protect).mockResolvedValue(undefined);
  });

  it('should call CheckStaleAgentsOrchestratorAction and return success', async () => {
