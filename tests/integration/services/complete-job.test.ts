...
import { CompleteJobAction } from '@/actions/complete-job';
import type { CompleteJobDTO } from '@/sdk/types';
...
describe('CompleteJobAction - Service Integration', () => {
  it('should execute successfully', async () => {
    ...
    const input: CompleteJobDTO = {} as never; // TODO: Provide valid mock data
