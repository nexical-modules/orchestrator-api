...
async function startSupervisor() {
    ...
    console.log('[DEBUG] Loading processors from registry:', jobProcessors);
    const initializedProcessors: Record<string, JobProcessor<any>> = {};
    for (const [key, ProcessorClass] of Object.entries(jobProcessors)) {
        const pClass = ProcessorClass as new (config: any) => JobProcessor<any>;
