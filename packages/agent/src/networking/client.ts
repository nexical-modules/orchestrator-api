...
export class AgentClient {
    ...
    public async register(dto: { id?: string; hostname: string; capabilities: string[] }): Promise<void> {
        console.log('[AgentClient] Registering agent:', dto);
        await this.client.orchestrator.agent.register(dto as any);
    }
